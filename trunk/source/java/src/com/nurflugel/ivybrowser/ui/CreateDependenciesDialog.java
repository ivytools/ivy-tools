...
//        dependenciesPanel.validate();
    ...
    {
        SortedList<IvyRepositoryItem> sortedDependencies =
                new SortedList<IvyRepositoryItem>(ivyPackages, new IvyRepositoryItemComparator());
        ...
        EventTableModel<IvyRepositoryItem> tableModel =
                new EventTableModel<IvyRepositoryItem>(filteredPackages, new IvyRepositoryItemTableFormat());
        dependenciesTable.setModel(tableModel);

        TableComparatorChooser<IvyRepositoryItem> tableSorter =
                new TableComparatorChooser<IvyRepositoryItem>(dependenciesTable, sortedDependencies, true);
