package com.nike.ivytracker.handlers;
...
import com.nike.ivytracker.domain.IvyFileImpl;
...
public class HtmlHandler extends SwingWorker<Object, Object>
{
    ...
    private void getIvyFileFromUrl(Map<String, IvyFile> ivyFilesMap, List<IvyFile> projectIvyFiles, String urlPath, String projectName) throws IOException
    {
        ...
        try {
            ...
            while (versionLine != null) {
                boolean shouldProcess = versionLine.contains("<li") && !versionLine.contains("..") && !versionLine.contains("md5") && !versionLine.contains("sha1");
                ...
                if (shouldProcess) {
                    ...
                    if (isIvyFile) {
                        ...
                        getIvyFile(url, ivyFileName, projectIvyFiles, "com.nike", projectName, "trunk", ivyFilesMap);
    ...
    private void getIvyFile(URL versionUrl, String ivyFileName, Collection<IvyFile> ivyFiles, String org, String module, String revision, Map<String, IvyFile> ivyFilesMap) throws IOException
    {
    ...
    private void findVersions(URL repositoryUrl, String orgName, String moduleName, Collection<IvyFile> ivyFiles, Map<String, IvyFile> ivyFilesMap) throws IOException
    {
    ...
    private void findVersionedLibrary(URL repositoryUrl, String orgName, String moduleName, String version, Collection<IvyFile> ivyFiles, Map<String, IvyFile> ivyFilesMap) throws IOException
    {
