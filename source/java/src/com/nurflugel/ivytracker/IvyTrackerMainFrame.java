 ...
 */
@SuppressWarnings({ "CallToPrintStackTrace", "UseOfSystemOutOrSystemErr", "IOResourceOpenedButNotSafelyClosed", "CallToSystemExit", "OverlyBroadCatchBlock" })
public class IvyTrackerMainFrame extends JFrame
{
    ...
    public IvyTrackerMainFrame()
    {
        ...
        countValueMatcherEditor    = new CountValueMatcherEditor(showAllLibrariesRadioButton, showOnlyUsedLibrariesRadioButton, showOnlyUnusedLibrariesRadioButton);
    ...
    private void exportTableToClipboard()
    {
        ...
        for (IvyFile ivyFile : list) {
            sb.append(ivyFile.getOrg()).append("\t").append(ivyFile.getModule()).append("\t").append(ivyFile.getVersion()).append("\t").append(ivyFile.getCount()).append("\n");
        }
    ...
    public boolean saveTestData() { return saveTestData; }
    ...
    public boolean useTestData() { return useTestData; }
    ...
    private void $$$setupUI$$$()
    {
        ...
        specifyIvyReposioryButton = new JButton();
        specifyIvyReposioryButton.setText("Specify Ivy Reposiory");
        gbc       = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 1;
        gbc.fill  = GridBagConstraints.HORIZONTAL;
        panel3.add(specifyIvyReposioryButton, gbc);
