...
public class HtmlHandler extends SwingWorker<Object, Object>
{
    ...
    private void getIvyFile(URL versionUrl, String ivyFileName, Collection<IvyFile> ivyFiles, String org, String module, String revision, Map<String, IvyFile> ivyFilesMap)
                     throws IOException
    {
    ...
    private void findModules(URL repositoryUrl, String orgName, Collection<IvyFile> ivyFiles, Map<String, IvyFile> ivyFilesMap)
                      throws IOException
    {
    ...
    private void findVersionedLibrary(URL repositoryUrl, String orgName, String moduleName, String version, Collection<IvyFile> ivyFiles, Map<String, IvyFile> ivyFilesMap)
                               throws IOException
    {
