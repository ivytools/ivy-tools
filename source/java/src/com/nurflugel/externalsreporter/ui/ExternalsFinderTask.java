...
public class ExternalsFinderTask extends SwingWorker<Object, Object>
{
    ...
    private void addToExternalsList(Map<BuildableProjects, Map<String, List<External>>> projectMap)
                             throws SVNException
    {
        ...
        for (BranchNode branch : branches)
        {
            ...
            mainFrame.addStatus("Getting externals for " + url + "        Time remaining: " + Util.calculateTimeRemaining(startTime, currentCount++, branches.size()));
