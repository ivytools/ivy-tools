...
public class OutputHandler
{
    ...
    public File writeDotFile(Map<BuildableProjects, Map<String, List<External>>> dependencies)
                      throws IOException
    {
    ...
    public File launchDot(File dotFile, File dotExecutable)
    ...
    public void viewResultingFile(File imageFile)
                           throws IOException
    {
